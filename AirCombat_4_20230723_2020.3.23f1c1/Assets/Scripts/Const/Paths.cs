...
public static partial class ResourcesPath//预制体路径
{ 
    ...
    public const string PREFAB_STARTGAME_PANEL =  "01/Prefabs/StartGamePanel";
    public const string PREFAB_SELECTED_HERO_VIEW = UI_FOLDER + "SelectedHeroView";
    public const string PREFAB_SELECTED_HERO_PANEL = "01/Prefabs/SelectHeroPanel";
    public const string PREFAB_STRENGTHEN_VIEW = UI_FOLDER + "StrengthenView";
    public const string PREFAB_STRENGTHEN_PANEL = "01/Prefabs/StrengthenPanel";
    public const string PREFAB_LEVELS_VIEW = UI_FOLDER + "LevelsView";
    public const string PREFAB_SELECTLEVEL_PANEL = "01/Prefabs/SelectLevelPanel";
    public const string PREFAB_HERO_PANEL = "01/Prefabs/SelectHeroPanel";
    public const string PREFAB_LEVEL_ITEM = UI_FOLDER + "LevelItem";
    public const string PREFAB_PROPERTY_ITEM = UI_FOLDER + "PropertyItem";
    public const string PREFAB_DIALOG_PANEL = UI_FOLDER + "DialogPanel";
    //public const string PREFAB_LOADING_VIEW = UI_FOLDER + "LoadingView";
    public const string PREFAB_LOADING_VIEW = UI_FOLDER + "LoadingView";
    public const string PREFAB_LOADING_PANEL =  "01/Prefabs/LoadingPanel";
    public const string PREFAB_GAME_UI_VIEW = UI_FOLDER + "GameUI";
    public const string PREFAB_GAME_UI_PANEL = UI_FOLDER +"GamePanel";
...
public static partial class ResourcesPath//game预制
{
    private const string Game_FOLDER = PREFAB_FOLDER + "Game/";
    public const string PREFAB_GAMEROOT = Game_FOLDER + "GameRoot";
    public const string PREFAB_MAP_CTRL = Game_FOLDER + "MapCtrl";
...
public static partial class ResourcesPath//Config配置路径
{ 
...
public static partial class ResourcesPath//音频路径
{
    ...
    public static readonly string AUDIO_FIRE = AUDIO_FOLDER + "/Buttle/Fire";
}