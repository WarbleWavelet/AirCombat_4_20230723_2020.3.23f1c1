...
public class GuideGenerateIDTool
{
    ...
    {
        ReplaceId(GROUP_FOLDER
            , GROUP_REPLACE_CONTENT_OLD
            , GROUP_REPLACE_CONTENT_NEW);
    }
    
    private static void GenerateGuideId()
    {
        ReplaceId(GUIDE_FOLDER
            , GUIDE_REPLACE_CONTENT_OLD
            , GUIDE_REPLACE_CONTENT_NEW);
    }

    private static void ReplaceId(string directoryPath
        ,string oldContent
        ,string newContent)
    {
