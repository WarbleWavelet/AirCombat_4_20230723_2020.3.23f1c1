...
namespace QFramework
{
    ...
    public partial class AudioManager : MonoBehaviour, ISingleton
    {
        ...
        private static Dictionary<string, List<AudioPlayer>> mSoundPlayerInPlaying = new Dictionary<string, List<AudioPlayer>>(30);
