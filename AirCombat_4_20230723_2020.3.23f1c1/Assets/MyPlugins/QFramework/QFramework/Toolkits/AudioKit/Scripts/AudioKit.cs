...
")]
        ...
        public static void PlayMusic(string musicName
            , bool loop = true
            , System.Action onBeganCallback = null
            , System.Action onEndCallback = null
            , bool allowMusicOff = true
            , float volume = -1f)
        {
...
")]
        ...
        public static AudioPlayer PlaySound(string soundName, bool loop = false, Action<AudioPlayer> callBack = null, int customEventId = -1)
        {
            AudioManager.Instance.CheckAudioListener();
...
")]
    ...
    /// <summary>
    /// AssetBundleName.AssetName （包名.资源名）
    /// </summary>
    public class AudioSearchKeys : IPoolType, IPoolable
    {
        ...
        {
            return $"AudioSearchKeys：AssetBundleName:{AssetBundleName}.AssetName:{AssetName} ";
        }
    }


    #region AudioLoaderPool
    ...
    /// <summary>
    /// Clip
    /// <br/>LoadClip、LoadClipAsync、Unload
    /// </summary>
    public interface IAudioLoader
    { 
        AudioClip Clip { get; }
        AudioClip LoadClip(AudioSearchKeys audioSearchKeys);
        /// <summary>加载好了就自己去执行onLoad。主线程不等3你了</summary>
    ...
    public class DefaultAudioLoader : IAudioLoader
    {
        ...
        /// <summary>Resources.Load&lt; AudioClip &gt;</summary>
        ...
        public void LoadClipAsync(AudioSearchKeys audioSearchKeys, Action<bool,AudioClip> onLoad)
        {
            ...
            resourceRequest.completed += operation =>
            {
                ...
                if(clip == null)//后面clip为空报错，resourceRequest不能给出路径，所以在这里用audioSearchKeys
                {
                    Debug.LogError("LoadClipAsync加载失败,AssetName"+ audioSearchKeys.AssetName);
                }
                onLoad(clip, clip);
            };
        }
