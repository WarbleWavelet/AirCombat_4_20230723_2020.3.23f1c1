...
public static partial class ExtendGameObject
{
    ...
    //public static MonoBehaviour Show(this MonoBehaviour monoBehaviour)
    //{
    //	monoBehaviour.gameObject.SetActiveSelf(true);
    //	return monoBehaviour;
    //}

    //public static MonoBehaviour Hide(this MonoBehaviour monoBehaviour)
    //{
    //	monoBehaviour.gameObject.SetActiveSelf(false);
    //		return monoBehaviour;
    //}
