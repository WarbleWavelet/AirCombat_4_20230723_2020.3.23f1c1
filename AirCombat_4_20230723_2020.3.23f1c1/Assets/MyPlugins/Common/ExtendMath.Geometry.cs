...
public static partial class ExtendGeometry //Angle=Degree,Radian,四元数,Vector2,Vector3 
{
    ...
    public static float Vector2To(this float angle, AngleType angleType)
    {
    ...
    public static float Angle2Degree(this float angle, AngleType angleType)
    {

        float degree;
        switch (angleType)
        {
            case AngleType.DEGREER:
                {
                    degree = angle;
                }
                break;
    ...
    public static float Angle2Radian(this float angle, AngleType angleType)
    {
