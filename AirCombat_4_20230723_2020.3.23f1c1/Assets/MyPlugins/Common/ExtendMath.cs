...
public static partial class ExtendMath // 数学巨人
{
    ...
    public enum E欧拉
    {
        ...
        变分法的欧拉方程,
        复变函数的欧拉公式,
        //欧拉还是数学史上最多产的数学家，他一生写下886种书籍论文，他的著作无穷小分析引论，微分学积分学是18世纪欧洲标准的微积分教科书，欧拉还创造了一批数学 符号f(x)、Σ、i、e，使得数学更容易表述和推广。在代数方面，欧拉可谓功勋卓著，《代数学入门》一书，是16世纪中期开始发展的代数学的一个系统总结。18世纪中叶，分析学领域有许多新的发现，其中不少是欧拉自已的工作。它们系统地概括在欧拉的《无穷分析引论》、《微分学原理》和《积分学原理》组成的分析学三部曲中。这三部书是分析学发展的里程碑四式的著作。此外，我们下学期要学的级数，欧拉也起到了重要作用。
