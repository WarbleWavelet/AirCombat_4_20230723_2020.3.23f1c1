...
{
    /// <summary>
    ///     Shortcuts/functions that are not strictly related _to specific Modules
    ...
    public static class DOTweenModuleUnityVersion
    {
        ...
        /// </summary>
        /// <param name="gradient">The gradient _to use</param>
        /// <param name="property">The name of the material property _to tween (like _Tint or _SpecColor)</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// </summary>
        /// <param name="elapsedLoops">Elapsed loops _to wait for</param>
        ...
        /// </summary>
        /// <param name="position">Position (loops included, delays excluded) _to wait for</param>
        ...
        ///     (meaning when the tween is set in a playing state the first timer, after any eventual delay).
        ///     It can be used inside a coroutine as a yield.
        ///     <para>Example usage:</para>
