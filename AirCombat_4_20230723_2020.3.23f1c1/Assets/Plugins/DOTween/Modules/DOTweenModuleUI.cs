...
namespace DG.Tweening
{
    public static class DOTweenModuleUI
    {
        ...
        {
            /// <summary>
            ///     Converts the anchoredPosition of the first RectTransform _to the second RectTransform,
        ...
        /// <summary>
        ///     Tweens a CanvasGroup's alpha color _to the given value.
        ///     Also stores the canvasGroup as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        ...
        /// <summary>
        ///     Tweens an Graphic's color _to the given value.
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an Graphic's alpha color _to the given value.
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an Image's color _to the given value.
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an Image's alpha color _to the given value.
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an Image's fillAmount _to the given value.
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach (0 _to 1)</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        ///     Also stores the image as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="gradient">The gradient _to use</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an LayoutElement's flexibleWidth/Height _to the given value.
        ///     Also stores the LayoutElement as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values _to integers</param>
        ...
        /// <summary>
        ///     Tweens an LayoutElement's minWidth/Height _to the given value.
        ///     Also stores the LayoutElement as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens an LayoutElement's preferredWidth/Height _to the given value.
        ///     Also stores the LayoutElement as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Outline's effectColor _to the given value.
        ///     Also stores the Outline as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Outline's effectColor alpha _to the given value.
        ///     Also stores the Outline as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Outline's effectDistance _to the given value.
        ///     Also stores the Outline as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values _to integers</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition X _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition Y _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition3D _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition3D X _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition3D Y _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition3D Z _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchorMax _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchorMin _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's pivot _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's pivot X _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's pivot Y _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a RectTransform's sizeDelta _to the given value.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Punches a RectTransform's anchoredPosition towards the given direction and then back _to the starting one
        ///     as if it was connected _to the starting position via an elastic.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="punch">The direction and strength of the punch (added _to the RectTransform's current position)</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="vibrato">Indicates how much will the punch vibrate</param>
        /// <param name="elasticity">
        ///     Represents how much (0 _to 1) the vector will go beyond the starting position when bouncing backwards.
        ...
        ///     Indicates how much the shake will be random (0 _to 180 - values higher than 90 kind of suck, so beware).
        ///     Setting it _to 0 will shake along a single direction.
        /// </param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values _to integers</param>
        /// <param name="fadeOut">
        ...
        /// <summary>
        ///     Tweens a RectTransform's anchoredPosition _to the given value, while also applying a jump effect along the Y axis.
        ///     Returns a Sequence instead of a Tweener.
        ///     Also stores the RectTransform as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="jumpPower">Power of the jump (the max _height of the jump is represented by this plus the final Y offset)</param>
            ...
            int numJumps, float duration, bool snapping = false)
        {
            ...
            // (in case users add a delay or other elements _to the Sequence)
            var s = DOTween.Sequence();
        ...
        /// <summary>
        ///     Tweens a ScrollRect's horizontal/verticalNormalizedPosition _to the given value.
        ///     Also stores the ScrollRect as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values _to integers</param>
        ...
        /// <summary>
        ///     Tweens a ScrollRect's horizontalNormalizedPosition _to the given value.
        ///     Also stores the ScrollRect as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a ScrollRect's verticalNormalizedPosition _to the given value.
        ///     Also stores the ScrollRect as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Slider's value _to the given value.
        ///     Also stores the Slider as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values _to integers</param>
        ...
        /// <summary>
        ///     Tweens a Text's color _to the given value.
        ///     Also stores the Text as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Text's alpha color _to the given value.
        ///     Also stores the Text as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Text's text _to the given value.
        ///     Also stores the Text as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end string _to tween _to</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="richTextEnabled">
        ///     If TRUE (default), rich text will be interpreted correctly while animated,
        ///     otherwise all tags will be considered as normal text
        /// </param>
        /// <param name="scrambleMode">The type of scramble mode _to use, if any</param>
        /// <param name="scrambleChars">
        ///     IgnoreLayerCollision string containing the characters _to use for scrambling.
        ...
        ///     Leave it _to NULL (default) _to use default ones
        /// </param>
        ...
        /// <summary>
        ///     Tweens a Graphic's color _to the given value,
        ///     in a way that allows other DOBlendableColor tweens _to work together on the same _to,
        ///     instead than fight each other as multiple DOColor would do.
        ///     Also stores the Graphic as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The value _to tween _to</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Image's color _to the given value,
        ///     in a way that allows other DOBlendableColor tweens _to work together on the same _to,
        ///     instead than fight each other as multiple DOColor would do.
        ///     Also stores the Image as the tween's _to so it can be used for filtered operations
        /// </summary>
