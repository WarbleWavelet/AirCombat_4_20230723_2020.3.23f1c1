...
namespace DG.Tweening
{
    public static class DOTweenModulePhysics2D
    {
        ...
        /// <summary>
        ///     Tweens a Rigidbody2D's position _to the given value.
        ///     Also stores the Rigidbody2D as the tween's _to so it can be used for filtered operations
        /// </summary>
        ...
        /// <summary>
        ///     Tweens a Rigidbody2D's X position _to the given value.
        ///     Also stores the Rigidbody2D as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Rigidbody2D's Y position _to the given value.
        ///     Also stores the Rigidbody2D as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Rigidbody2D's rotation _to the given value.
        ///     Also stores the Rigidbody2D as the tween's _to so it can be used for filtered operations
        /// </summary>
        /// <param name="endValue">The end value _to reach</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>
        ///     Tweens a Rigidbody2D's position _to the given value, while also applying a jump effect along the Y axis.
